...
function setup() {
  ...
  invisibleGround = createSprite(trex.x,height-10,width*3,125);  
  invisibleGround.shapeColor = "#f4cbaa";
  invisibleGround.visible=false
  
  //ground = createSprite(0,height,width*50,2);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    image(groundImage,trex.x-width/2,height-100,width,125)
...
function spawnClouds() {
  ...
  for(var o=200; o<width*3; o=o+700) {
    var cloud = createSprite(o,height-300,40,10);
...
function spawnObstacles() {
  for(var o=200; o<width*3; o=o+500) {
    var obstacle = createSprite(o,height-95,20,30);
